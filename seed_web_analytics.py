#!/usr/bin/env python3
"""
Seed script to add Web Analytics documentation content to the ContentHub database.
This script creates a category for Web Analytics and adds the getting started guide.
"""
...
def create_web_analytics_category():
    """Create or update Web Analytics category"""
    category_name = "Web Analytics"
...
def create_getting_started_content(category_id):
    ...
    if existing_content:
        print(f"Content 'Getting started with Vercel Web Analytics' already exists")
        return existing_content['_id']
    
    content_text = """# Getting started with Vercel Web Analytics
...
"""
    ...
    print(f"Created content 'Getting started with Vercel Web Analytics' with ID: {result.inserted_id}")
    return result.inserted_id

def main():
    """Main function to seed the database"""
    print("Starting Web Analytics documentation seeding...")
    
    try:
        # Step 1: Create or get the category
        category_id = create_web_analytics_category()
        
        # Step 2: Create the getting started content
        content_id = create_getting_started_content(category_id)
        
        print("\n✅ Successfully seeded Web Analytics documentation!")
