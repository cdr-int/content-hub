...
Choose your framework below for detailed instructions:

- [Next.js (Pages Directory)](#nextjs-pages-directory)
- [Next.js (App Directory)](#nextjs-app-directory)
...
> **💡 Note:** For HTML sites, you can skip this step and use the script tag directly.
...
### Astro - Legacy Configuration (Versions before @vercel/analytics@1.4.0)
